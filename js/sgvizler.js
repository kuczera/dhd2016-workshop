...
// 2015-07-24, schradt, hardfix to bring Sesame into returning JSON results; failed to set this with sgvizlers attribute options
			...
			var
					...
					linkify = function (url, arraySyntax) {
						...
						if (link) {
							...
							if (base) {
// 2015-07-27, schradt, no base url necessary
								// href = base + url;
								href = url;
							}
